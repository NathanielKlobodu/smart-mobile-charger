...
## Hardware Components
 ...
 ## Software Components
  * Arduino IDE for writing and uploading code to the MCU. The code is available [here](/smart-mobile-charger/Smart_Mobile_Charger/Smart_Mobile_Charger.ino)
  * Smartphone app for controlling the charger and setting charging thresholds. The .apk file is available [here](smart-mobile-charger/Application Files/Smart_Mobile_Charger.apk) and the raw .aia code file which was designed with [MIT App Inventor](https://appinventor.mit.edu/) is available [here](smart-mobile-charger/Application Files/Smart_Mobile_Charger.aia).
